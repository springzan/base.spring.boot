...
import com.own.service.springboot.api.sign.SignException;
import com.own.service.springboot.api.user.UserException;
...
public class APIExceptionHandler {
    ...
    public ResponseEntity<ErrorApiResponse> signTimeoutExceptionHandler(HttpServletRequest request,
        ...
        StringBuilder message=new StringBuilder(request.getRequestURI())
                .append(e.getMessage());
        if(SpringMvcUtil.getTraceParameter(request)){
            message.append("\n\r");
